...
class WishSelectCoin extends StatefulWidget {
  var wishedItemDetails;

  WishSelectCoin({super.key, required this.wishedItemDetails});

  @override
  State<WishSelectCoin> createState() => _WishSelectCoinState();
}

class _WishSelectCoinState extends State<WishSelectCoin> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
      appBar: AppBar(
        title: Text('${widget.wishedItemDetails.name}\'s Chart'),
      ),
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    Hero(
                      tag: widget.wishedItemDetails.image,
                      child: SizedBox(
                          height: myHeight * 0.08,
                          child: Image.network(widget.wishedItemDetails.image)),
                    ),
                    SizedBox(
                      width: myWidth * 0.03,
                    ),
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.wishedItemDetails.symbol,
                          style: const TextStyle(
                              fontSize: 20,
                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      Text(
                        '\$${widget.wishedItemDetails.currentPrice}',
                        style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.normal,
                            color: Colors.black),
                      ...
                      Text(
                        '${widget.wishedItemDetails.marketCapChangePercentage24H}%',
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.normal,
                            color: widget.wishedItemDetails
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Text(
                            '\$${widget.wishedItemDetails.low24H}',
                            style: const TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.normal,
                              color: Colors.black,
                      ...
                      Column(
                        children: [
                          ...
                          Text(
                            '\$${widget.wishedItemDetails.high24H}',
                            style: const TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.normal,
                              color: Colors.black,
                      ...
                      Column(
                        children: [
                          ...
                          Text(
                            '\$${widget.wishedItemDetails.totalVolume.toStringAsFixed(2).toString()}M',
                            style: const TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.normal,
                              color: Colors.black,
  ...
  Future<void> getChart() async {
    String url =
        '${'https://api.coingecko.com/api/v3/coins/' + widget.wishedItemDetails.id}/ohlc?vs_currency=usd&days=$days';
